    ...
    <>
      {isConnected ? (
        ...
        <div className="flex mr-20 px-10">
          ...
          <h3 className="truncate absolute text-white bg-[#FF0090] rounded-full font-bold px-2 py-1 w-40 z-10 bottom-7">{walletAddress}</h3>
       ...
       <svg
         ...
         className="ml-5 h-8 w-8 bg-[#FF0090] rounded-full ml-20 z-10"
         fill="none"
         viewBox="0 0 24 24"
         stroke="currentColor"
         strokeWidth={2}
